...
public class TranslationService {
    ...
    TranslationService(Map<String, Map<String, String>> resources) {
        this(resources, true);
    }
    ...
    public String translate(
        ...
        String template = resolveTemplate(resolveLanguage(language), key);
    ...
    private String resolveTemplate(String language, String key) {
        ...
        Map<String, String> defaultResource = resources.get(DEFAULT_LANGUAGE);

        if (defaultResource != null && defaultResource.containsKey(key)) {
            return defaultResource.get(key);
        }
