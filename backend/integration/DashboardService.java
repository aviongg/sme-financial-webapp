...
public class DashboardService {
    ...
    public DashboardResponse getDashboard(UUID userId) {
        ...
        // Lock the profile and current/previous score before any JPA profile or score read.
        // This transaction keeps displayed scores and translated advice on one persisted snapshot.
        ...
        Optional<ScoreResult> latestScoreOpt = adviceContext.flatMap(context ->
                scoringService.getScore(userId, context.score().getMonth()));
